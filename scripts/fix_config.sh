#!/bin/bash
# Fix the training configuration file

set -e

echo "Fixing training configuration..."

cat > /workspace/LTX_video_training/LTX-Video-Trainer/configs/trajectory_control_h100.yaml << 'EOF'
# Trajectory Control IC-LoRA Training Configuration
# Based on official ltxv_13b_ic_lora.yaml format
...
echo ""
echo "Config location: /workspace/LTX_video_training/LTX-Video-Trainer/configs/trajectory_control_h100.yaml"
